 ...
 * @Date: 2026-03-25 14:59:13
 * @LastEditors: eren dengdengd1222@mail.com
 * @LastEditTime: 2026-03-25 19:24:49
 * @FilePath: /my_agent_communication/mcp/src/mcp_agent_integration.cpp
 * @Description: using
 * 
 */
...
std::string MCPAgentIntegration::getStatusDescription() const {
    ...
    std::lock_guard<std::mutex> locker(tool_cache_mutex_);
...
MCPAgentConfig parseMCPConfigFromEnv() {
    ...
    // MCP_SERVER_PATH
    const char* server_args = std::getenv("MCP_SERVER_PATH");
