 ...
 * @Date: 2026-03-30 14:25:42
 * @LastEditors: eren dengdengd1222@mail.com
 * @LastEditTime: 2026-03-30 15:37:22
 * @FilePath: /my_agent_communication/a2a/include/a2a/models/agent_message.hpp
 * @Description: 
 * 
 */
#pragma once
...
public:
    ...
    /**
     * @brief Get the first text part content (convenice method)
     */
