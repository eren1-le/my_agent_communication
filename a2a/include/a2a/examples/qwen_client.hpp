 ...
 * @Date: 2026-03-30 10:25:58
 * @LastEditors: eren dengdengd1222@mail.com
 * @LastEditTime: 2026-03-30 12:12:17
 * @FilePath: /my_agent_communication/a2a/include/a2a/examples/qwen_client.hpp
 * @Description: 
 * 
 */
#pragma once
...
public:
     ...
     */
     ...
     // 发送HTTP 请求
     std::string reponse = send_post_request(request_str);

     // 解析响应
     try {
        json response_json = json::parse(reponse);
